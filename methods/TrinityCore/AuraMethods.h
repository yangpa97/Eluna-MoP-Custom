...
namespace LuaAura {
/**
 * Returns the [Unit] that casted the [Spell] that caused this [Aura] to be
 * applied.
 *
 * @return [Unit] caster
 */
...
/**
 * Returns the GUID of the [Unit] that casted the [Spell] that caused this
 * [Aura] to be applied.
 *
...
/**
 * Returns the level of the [Unit] that casted the [Spell] that caused this
 * [Aura] to be applied.
 *
 ...
 *
 * @return int32 max_duration : the maximum duration of the Aura, in
 * milliseconds
 */
