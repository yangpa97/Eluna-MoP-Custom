 ...
 */
int GetMembersCount(Eluna *E, Guild *guild) {
...
/**
 * Sends a [WorldPacket] to all the [Player]s at the specified rank in the
 * [Guild]
 *
 * @param [WorldPacket] packet : the [WorldPacket] to be sent to the [Player]s
 ...
 * @param bool isDisbanding : default 'false', should only be set to 'true' if
 * the guild is triggered to disband
 */
...
ElunaRegister<Guild> GuildMethods[] = {
    ...
    {"GetMemberCount", &LuaGuild::GetMembersCount},
