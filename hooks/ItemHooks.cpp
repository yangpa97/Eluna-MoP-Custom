...
void Eluna::OnDummyEffect(WorldObject *pCaster, uint32 spellId,
...
bool Eluna::OnUse(Player *pPlayer, Item *pItem,
  ...
  // This is a hack fix to stop spell casting visual bug when a spell is not
  // cast on use
